	...
	if(wave_started) and !game_complete{
		if (spawn_enemy == true){
			...
			switch(enemy_spawn_type)
			{
				...
				case 3:	if(spawn_left_enemy3 > 0){
							alarm_set(2, enemy2_spawn_interval)
							spawn_enemy = false
							spawn_left_enemy3 -= 1
							break
				}
		...
		if(wave_number == 1 and enemies_left == 0){
			game_complete = true
			alarm[4] = 1
		}
	}
