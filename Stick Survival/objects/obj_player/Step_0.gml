...
if (keyboard_check(ord("W")) || keyboard_check(vk_up)) {		//player jumps when standing on block
	if instance_place(x, y+1, obj_block){vspeed -= jump_height}
}