...
if instance_exists(obj_player){
	...
	if (distance_to_object(obj_player) <= range and canFire) {
            instance_create_layer(x, y-12, layer, obj_bullet)
			canFire = false
			alarm[3] = 30
	}
}
